...
class FieldsInicial extends StatefulWidget {
  ...
  const FieldsInicial({super.key, required this.paciente}); // Construtor
...
class _FieldsInicialState extends State<FieldsInicial> {
  ...
  final _fieldsinicial = const [
    ...
    },
    {
      ...
      'validator': 'Por favor, insira o SpO2 inicial'
    },
    {
      'label': 'Pressão Arterial',
      'validator': 'Por favor, insira a PA inicial'
    },
    {
      'label': 'Percepção Subjetiva de Esforço',
      'validator': 'Por favor, insira a PSE inicial'
    },
    {
      'label': 'Dor Torácica',
  ...
  Widget buildField(BuildContext context, int index) {
    if (index == 0) {
      ...
      // Para os outros índices, mantém o comportamento anterior
      return Padding(
        padding: const EdgeInsets.all(8.0),
        child: AlertDialog(
